...
- The refiner lands by **push-first CAS and never `--force`es a shared branch** (ADR 0012); a ref checked out in any worktree cannot be advanced by the refinery merge.
