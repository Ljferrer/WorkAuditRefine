...
description: "/red-team's two ADR-0025 drift-guard probes are doctrine-level prose the Lead runs directly on every plan — they are deliberately NOT entries in the scaffold's fixed SPINE array"
metadata: 
  node_type: memory
  type: project
