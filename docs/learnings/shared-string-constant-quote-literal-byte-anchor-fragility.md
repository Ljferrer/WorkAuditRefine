...
description: "A both-surfaces drift test anchored on a shared string constant containing literal quote-mark examples is byte-fragile to a future quote-style normalization on either surface"
metadata:
  type: project
