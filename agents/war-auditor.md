...
The standing duties of this seat moved byte-identical to a references file (ADR 0042): when you sit as the `execution-evidence` seat, read [gate-audit-checklist.md](${CLAUDE_PLUGIN_ROOT}/skills/war/references/gate-audit-checklist.md).
