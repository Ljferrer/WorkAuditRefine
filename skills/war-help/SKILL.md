...
| `/war-survey-corps` | sweep open issues into war-shaped specs ([`../../README.md`](../../README.md#pro-tip)) |
| `/war-machine` | convert specs to plans + a roadmap, hand off to the campaign ([`../../README.md`](../../README.md#pro-tip)) |
| `/war-campaign` | run a queue of plans unattended — **never auto-invokes** ([`../../README.md`](../../README.md#run-a-campaign-war-campaign)) |
| `/war-aftermath` | evidence-gated post-campaign cleanup — **never auto-invokes** ([`../../README.md`](../../README.md#pro-tip)) |
