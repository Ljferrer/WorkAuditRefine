...
## Evicted: the two `*-proceed` dispatch flavors are NOT symmetric (from the gate-failure classification section, now `gate-failure-classification.md`)
