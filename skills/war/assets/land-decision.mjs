...
// exclusion-set, release-slot, floor-skipped (a seat row filed with no intake floor run: a failed
// probe, or a row raised at the escalation arm, the sweep, or the terminal pass, where no probe applies),
